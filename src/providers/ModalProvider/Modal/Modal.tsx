...
import { CreateDeckModal } from './Contents/CreateDeckModal';
...
export const Modal = () => {
  ...
  function renderModalContents() {
    switch (modalType) {
      case ModalType.CREATEDECK:
        return <CreateDeckModal />;
      ...
      >
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full justify-center p-4 text-center items-center sm:p-0">
            ...
            >
              <Dialog.Panel
                className="relative transform overflow-hidden rounded-lg shadow-xl transition-all sm:my-8 sm:min-w-[600px] text-left
